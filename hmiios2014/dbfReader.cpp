            ...
            for (i = 0; i < DBFGetFieldCount(hDBF); i++)
            {
                ...
                if (!strcmp(szTitle, "name"))
                {
                    ...
                    // else
                    {
                        ...
                        {
                            case FTString: {
                                entity[iRecord].stringValue =
                                    (char*)malloc(strlen(DBFReadStringAttribute(hDBF, iRecord, i)) + 1);
                    ...
                    // else
                    {
                        switch (eType)
                        {
                            case FTString: {
                                ...
                                entity[l_iNumberOfLayerItem].stringValue =
                                    (char*)malloc(strlen(DBFReadStringAttribute(hDBF, iRecord, i)) + 1);
                                sprintf(entity[l_iNumberOfLayerItem].stringValue,
